    ...
    <div>
      <header>
        ...
        <div className="container">
          <h1 className="center">ZOA Energy</h1>
          <p>
            <b>Energy for</b>
            <br /> <b>Everyday Warriors!</b>
            <br />
            <br />
            ZOA is about <strong>healthy</strong>,{" "}
            <strong>positive energy</strong> that helps us <br /> all focus, be
            productive, and get stronger together.
            <br />
            <br /> ZOA is designed to <strong>
              support healthy immunity
            </strong>{" "}
            while
            <br /> providing a <strong>boost of energy and hydration</strong>.
            It <br />
            contains a unique blend of 100% DV Vitamin C from <br /> natural
            sources including{" "}
            <strong>
              Camu Camu and Acerola <br /> plus B-vitamins and electrolytes
            </strong>
            . <br />
            <br />
            Mana. Gratitude. ZOA
          ...
          <div className="btns">
            ...
            <a className="btn-secondary" href="#information">
              More Info
            </a>
          </div>
        </div>
        <img className="App-logo" src={zoa} alt="Zoa Energy"></img>
      </header>
    </div>
  );
}
